...
with torch.cuda.device(1):
    ...
    #IID
    IID_style = net(style) # Style image -> PIE-NET
        ...
        for iter_id, batch_begin in pbar:
            ...
            if optim_type == "ray":
                ...
                def postProcessing(img):
                    ...
                    img = (img / img.max()) * 255  # 0~1 value scaling
                ...
                def compute_image_loss(device):
                    ...
                    with torch.cuda.device(3):
                        ...
                        IID_content = net(content)
                        IID_styled = net(styled)

                        # albedo (equal reflectance)
                        albedo_styled = IID_styled['reflectance']

                        # shading
                        shading_content = IID_content['shading']                       
                        shading_styled = IID_styled['shading']
                    ...
                    loss_dict = shading_content_loss
